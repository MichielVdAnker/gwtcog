 ...
 */
package gwtcog.core.util.arrayutil;

import gwtcog.core.Encog;
import gwtcog.core.SimpleName;
import gwtcog.core.mathutil.Equilateral;
...
public class NormalizedField implements Serializable {
	...
	public final ClassItem determineClass(final double[] data) {
		...
		case SingleField:
			...
			break;
		default: 
			//TODO throw new QuantError("Unknown action: " + action);
		}
...
//						+ "to make use of equilateral normalization.");
	...
	public final void makeClass(final NormalizationAction theAction,
		...
		if ((theAction != NormalizationAction.Equilateral)
			...
			//TODO throw new QuantError("Unsupported normalization type");
		}
