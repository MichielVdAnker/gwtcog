...
public class EncogFileSection {
	...
	public static ActivationFunction parseActivationFunction(String value) {
		...
		//final String afName = "gwtcog.core.engine.network.activation." + cols[0];
//		try {
			//final Class<?> clazz = Class.forName(afName);
//			final Class<?> clazz = ActivationFactory.getActivationFunctionClass(cols[0]);
//			af = (ActivationFunction) clazz.newInstance();
			af = ActivationFactory.getActivationFunction(cols[0]);
...
//		return result;
	...
	public final String toString() {
		final StringBuilder result = new StringBuilder("[");
		result.append(SimpleName.get(this));
