package gwtcog.core.neural.rbf;
///*
...
//import gwtcog.core.neural.flat.FlatNetworkRBF;
//import gwtcog.core.neural.networks.BasicNetwork;
//import gwtcog.core.persist.EncogFileSection;
//import gwtcog.core.persist.EncogPersistor;
//import gwtcog.core.persist.EncogReadHelper;
//import gwtcog.core.persist.EncogWriteHelper;
//import gwtcog.core.persist.PersistConst;
//import gwtcog.core.persist.PersistError;
//import gwtcog.core.util.csv.CSVFormat;
//import gwtcog.core.client.util.SimpleName;
//
///**
...
//							.splitColumns(line);
//					final String name = "gwtcog.core.engine.network.activation."
//							+ cols.get(0);
//					try {
...
//					final List<String> cols = EncogFileSection
//							.splitColumns(line);
//					final String name = "gwtcog.core.mathutil.rbf." + cols.get(0);
//					try {
//						final Class<?> clazz = Class.forName(name);
...
//			out.addColumn(SimpleName.get(af));
...
//			out.addColumn(SimpleName.get(rbf));
