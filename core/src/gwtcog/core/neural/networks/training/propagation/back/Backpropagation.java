 ...
 */
package gwtcog.core.neural.networks.training.propagation.back;
...
import gwtcog.core.neural.networks.training.Momentum;
...
import gwtcog.core.neural.networks.training.strategy.SmartLearningRate;
import gwtcog.core.neural.networks.training.strategy.SmartMomentum;
import gwtcog.core.util.validate.ValidateNetwork;
...
public class Backpropagation extends Propagation implements Momentum,
	...
	public boolean isValidResume(final TrainingContinuation state) {
		...
		if (!state.getTrainingType().equals(SimpleName.get(this))) {
			return false;
		}
	...
	public TrainingContinuation pause() {
		...
		result.setTrainingType(SimpleName.get(this));
