 ...
 */
package gwtcog.core.neural.networks.training.lma;
...
import gwtcog.core.mathutil.matrices.hessian.ComputeHessian;
import gwtcog.core.mathutil.matrices.hessian.HessianCR;
...
import gwtcog.core.neural.networks.structure.NetworkCODEC;
...
public class LevenbergMarquardtTraining extends BasicTraining implements MultiThreadable {
	...
	public void updateWeights() {
		final double[] w = CloneTool.clone(this.weights);//this.weights.clone();
