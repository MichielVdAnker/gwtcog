...
import gwtcog.core.ml.ea.codec.GenomeAsPhenomeCODEC;
import gwtcog.core.ml.ea.genome.Genome;
import gwtcog.core.ml.ea.opp.EvolutionaryOperator;
import gwtcog.core.ml.ea.opp.OperationList;
import gwtcog.core.ml.ea.opp.selection.SelectionOperator;
import gwtcog.core.ml.ea.opp.selection.TournamentSelection;
import gwtcog.core.ml.ea.population.Population;
import gwtcog.core.ml.ea.rules.BasicRuleHolder;
import gwtcog.core.ml.ea.rules.RuleHolder;
import gwtcog.core.ml.ea.score.AdjustScore;
import gwtcog.core.ml.ea.score.parallel.ParallelScore;
import gwtcog.core.ml.ea.sort.GenomeComparator;
import gwtcog.core.ml.ea.sort.MaximizeAdjustedScoreComp;
import gwtcog.core.ml.ea.sort.MaximizeScoreComp;
import gwtcog.core.ml.ea.sort.MinimizeAdjustedScoreComp;
import gwtcog.core.ml.ea.sort.MinimizeScoreComp;
import gwtcog.core.ml.ea.species.SingleSpeciation;
...
//		}
	...
	public void iteration() {
		...
		//added a temp array to contain the workers
		ArrayList<EAWorker> workers = new ArrayList<EAWorker>();
